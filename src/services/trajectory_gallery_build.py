...
FIGURE_GROUPS: dict[str, dict[str, str]] = {
    ...
    "D": {"group_id": "mindoro_primary_validation_overlays", "label": "Mindoro March 13 -> March 14 primary-validation overlays"},
    "E": {"group_id": "mindoro_crossmodel_comparison_maps", "label": "Mindoro March 13 -> March 14 cross-model comparison maps"},
...
class TrajectoryGalleryBuildService:
    ...
    def _build_figures(self) -> None:
        ...
        copy_specs = [
            {
                "source_relative_path": "output/CASE_MINDORO_RETRO_2023/phase3b_extended_public_scored_march13_14_reinit/qa_march13_seed_vs_march14_target.png",
                "figure_group_code": "D",
                "case_id": "CASE_MINDORO_RETRO_2023",
