...
class UiAppSmokeTests(unittest.TestCase):
    ...
    def test_pages_render_via_wrapper_functions(self):
        for wrapper, expected_title in (
            ...
            (_mindoro_validation_wrapper_for_test, "Primary Mindoro March 13-14 Validation Case (B1)"),
            (_mindoro_validation_archive_wrapper_for_test, "Archive/Provenance and Legacy Support"),
            (_cross_model_wrapper_for_test, "Mindoro Same-Case OpenDrift-PyGNOME Comparator (Track A)"),
