...
| `mindoro_phase4_only` | scientific/reportable | `mindoro_retro_2023` | rerun only the Mindoro support-only oil-type/shoreline bundle | moderate | `.\start.ps1 -Entry mindoro_phase4_only -NoPause` |
| `mindoro_reportable_core` | scientific/reportable | `mindoro_retro_2023` | intentional rerun of the main Mindoro validation chain | expensive | `.\start.ps1 -Entry mindoro_reportable_core -NoPause` |
