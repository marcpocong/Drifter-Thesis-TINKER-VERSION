...
| `Table 4.6` | This table is reproduced from the stored B1 branch-survival and displacement diagnostics. | `output/CASE_MINDORO_RETRO_2023/phase3b_extended_public_scored_march13_14_reinit/march13_14_reinit_branch_survival_summary.csv`; `output/CASE_MINDORO_RETRO_2023/phase3b_extended_public_scored_march13_14_reinit/march13_14_reinit_branch_pairing_manifest.csv`; `output/CASE_MINDORO_RETRO_2023/phase3b_extended_public_scored_march13_14_reinit/march13_14_reinit_summary.csv` | Observation-independence note remains explicit. |
...
| `Table 4.9` | This table is reproduced from the stored Track A OpenDrift-vs-PyGNOME comparator scorecards. | `output/CASE_MINDORO_RETRO_2023/phase3b_extended_public_scored_march13_14_reinit_pygnome_comparison/march13_14_reinit_crossmodel_summary.csv`; `output/CASE_MINDORO_RETRO_2023/phase3b_extended_public_scored_march13_14_reinit_pygnome_comparison/march13_14_reinit_crossmodel_model_ranking.csv` | Comparator support only. PyGNOME is not the observational scoring reference. |
